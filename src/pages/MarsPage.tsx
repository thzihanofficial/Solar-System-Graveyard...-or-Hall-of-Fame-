            ...
            >
              ...
              <div className="p-6 md:p-10 flex flex-col justify-between flex-grow md:w-1/2">
                <div>
                  ...
                  <span className="text-[17px] sm:text-[19px] font-black text-[#ff6b4a] uppercase tracking-widest mb-5 block border-l-4 border-[#ff6b4a] pl-3 py-0.5">
                    {card.time}
                  </span>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                  <button
                    ...
                    className="w-full sm:w-auto text-center py-3.5 px-7 bg-[#ff6b4a] hover:bg-[#ff7b5d] text-[16px] font-black uppercase border-2 border-white text-white shadow-[4px_4px_0px_0px_#ffffff] transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0 active:translate-y-0 active:shadow-none cursor-pointer"
                  >
                    Read My Story
                  </button>
