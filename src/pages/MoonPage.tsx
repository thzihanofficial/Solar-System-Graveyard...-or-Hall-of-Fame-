        ...
        <div className="flex flex-col items-center gap-8 w-full max-w-6xl mx-auto">
          {[
            ...
            >
              ...
              <div className={card.fitImage ? "p-8 md:p-10 flex flex-col justify-between flex-grow md:w-1/2 gap-6" : "p-6 md:p-8 flex flex-col justify-between flex-grow md:w-1/2"}>
                <div>
                  <h3 className="text-[28px] sm:text-[38px] md:text-[42px] font-black uppercase text-white mb-2 tracking-tight leading-tight">
                    {card.name}
                  </h3>
